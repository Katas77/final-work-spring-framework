...
- Теперь достаточно просто пометить метод контроллера этой аннотацией — и все входящие DTO, реализующие интерфейс SchemaValidator, автоматически пройдут бизнес-валидацию без дублирования кода и явных вызовов.
