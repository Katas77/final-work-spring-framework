...
**Back-end часть сервиса бронирования отелей**

![image](./image/6.jpg)

## Общее описание
Сервис позволяет управлять отелями, номерами, пользователями и бронированиями через REST API.
...
📊 **Вы можете скачать полный отчёт в формате CSV** по эндпоинту: `GET /statistics/download` → файл `statistic_ГГГГ_ММ_ДД.csv`
